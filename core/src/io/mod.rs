...
// VORTEX_RDF_LEGACY_SIDECAR_API_BOUNDARY_V1
pub use cottas_native_ids::{
    CottasNativeConfig, NativeIndexPolicy, NativeRdfStoreFile, match_native_rdf_store_file,
    serialize_cottas_native_quad_source_v10_file,
};

#[cfg(feature = "legacy-sidecars")]
pub use cottas_native_ids::{
    CottasNativeIdsDiagnostics, NativeIdsCountMode, build_cottas_native_o_exact_ranges_index,
    build_cottas_native_po_predicate_partitions_v2, build_cottas_native_subject_range_index,
    build_cottas_native_term_directory, count_cottas_native_ids_file_with_diagnostics,
