...
| `BENCH_SUBJ_RATIO` | 1.0 | distinct subjects / rows |
...
At the defaults this is 2,097,152 triples over ~3.1M distinct terms, and each adapter process peaks at 4–6 GB — check available memory before running, because a swapping run produces numbers that look like regressions.
